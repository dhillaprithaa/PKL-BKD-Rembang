...
class DashboardAdminController extends Controller
{
    function index()
    {
        ...
        return view('admin.index', compact('chartDataGender', 'chartDataStatusGender'));
    }

    function pengaduanMasyarakat()
    {

        return view('admin.pengaduan-masyarakat');
    }

    function surveyKepuasan()
    {

        return view('admin.survey-kepuasan');
    }
}
